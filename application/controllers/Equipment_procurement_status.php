...
class Equipment_procurement_status extends CI_Controller {
  ...
  private function load_defaults(){  
    ...
    $this->data['table_operator'][] = array(
      'label' => 'Update',
      'controller_method' => 'equipment_procurement_status/get_procurement_status',
      'equipment_procurement_status_id' => 'equipment_procurement_status_id'
    );
  }
  ...
  private function set_pagination_data(){
    $this->data['pagination_action'] = 'equipment_procurement_status/index';
