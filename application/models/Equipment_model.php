...
class Equipment_model extends CI_Model {
  ...
  private $equipment_form_fields = array(
    ...
    'equipment_type_id'	=> array('Equipment Type', 'select', 'equipment_type'),
    'equipment_procurement_type_id' => array('Procurement type', 'input', 'number'),
    'manufacturer_id'	=> array('Manufacturer', 'select', 'vendor_name'),
    ...
    'donor_id' => array('Donor', 'select', 'donor_name'),
    'procured_by_id' => array('Procured By', 'select', 'vendor_name'),
    'purchase_order_date' => array('Order Date', 'input', 'date'),
    'cost' => array('Cost', 'input', 'number'),
    'supplier_id' => array('Supplier', 'select', 'vendor_name'),
    ...
    'functional_status_id' => array('Functional Status', 'select', 'working_status'),
    'procurement_status_id'	=> array('Procurement Status', 'select', 'procurement_status')
  );

  function get_equipment_form_fields(){
    return $equipment_form_fields;
  }
